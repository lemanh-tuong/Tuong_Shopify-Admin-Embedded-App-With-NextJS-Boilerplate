import { LocationStates } from 'src/routes/LocationStates';

export type LiteralUnion<T extends U, U = string> = T | U;
export type LiteralUnionAndObject<T extends string, Base> = Base | (T & string);
...
export type _Split<S extends string, D extends string, A extends any[] = []> = S extends `${infer T}${D}${infer U}`
